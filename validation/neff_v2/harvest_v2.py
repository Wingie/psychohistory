...
list=usercontribs). Resumable: skips runs already cached. Run: py -3.12 harvest_v2.py
"""
import json
import os
import sys
...
def main():
    ...
    sys.stderr.write(f"harvesting {len(runs)} runs ({len(R.EVENTS)} fresh articles x event+calm)\n")
