...
| F-03 | Regulatory argument built on the wrong FLOP number | **CRITICAL** | **Fixed and promoted**, §13.2 + Conjecture 2 |
...
| F-07 | Latent dispatch claimed as confidentiality protection | **HIGH** | **Withdrawn**, §9.1 Remark 6 |
| F-08 | Canary AUROC 1.0 generalised beyond its adversary model | **HIGH** | **Bounded**, §10.1 + Conjecture 1, falsifier F8 |
| F-09 | Master router is an unanalysed single point of failure | **MEDIUM** | **Solved**, §4. Bandit training signal, verifiability asymmetry, failure ladder, descriptor warm-start, post-routing mask |
| F-10 | No fault tolerance or straggler analysis anywhere | **MEDIUM** | **Solved**, §11.3. Three failure paths, one contract each |
...
| F-14 | Domain partition asserted, never justified | **LOW-MED** | **Solved**, §3.4. A three-axis criterion, which says **four towers, not five** |
| F-15 | Prop. 2 requires overlapping corpora while §13 treats towers as clean residency partitions | **MEDIUM**, found late | **Solved**, §11.4. Split by residency class, and the headroom shrinks |

**Everything except F-04 and F-13 is closed.** F-04 cannot be closed by argument, only by a training run.
...
**Fixed and promoted:** §13.2 and Conjecture 2 (*modular composition is a compute-threshold arbitrage surface*). This is now the paper's strongest original contribution: it came out of chasing down a wrong number.
...
**Fixed:** §9.1 Remark 6. Benefit retained, confidentiality claim withdrawn.
